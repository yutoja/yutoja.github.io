          ...
          typeof (i = function () {
            if ('object' === ('undefined' == typeof window ? 'undefined' : r(window)) && void 0 !== document.querySelectorAll && void 0 !== window.pageYOffset && void 0 !== history.pushState) {
              var e = function (e, t, n, i) {
                  return n > i ? t : e + (t - e) * ((a = n / i) < 0.5 ? 4 * a * a * a : (a - 1) * (2 * a - 2) * (2 * a - 2) + 1)
                  var a
                },
                t = function (t, n, i, a) {
                  n = n || 500
          ...
          i(e, [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                ;(this.player.template.listOl.innerHTML += (0, a.default)({ theme: this.player.options.theme, audio: e, index: this.audios.length + 1 })),
              ...
              value: function () {
                ...
                this.loadingChecker = setInterval(function () {
                  e.enableloadingChecker &&
                    ((n = e.player.audio.currentTime), i || n !== t || e.player.audio.paused || (e.player.container.classList.add('aplayer-loading'), (i = !0)), i && n > t && !e.player.audio.paused && (e.player.container.classList.remove('aplayer-loading'), (i = !1)), (t = n))
                }, 100)
              },
            },
            {
                  ...
                  if (this.async) {
                    ...
                    n.onreadystatechange = function () {
                      e === t.player.list.index &&
                        4 === n.readyState &&
                        ((n.status >= 200 && n.status < 300) || 304 === n.status ? (t.parsed[e] = t.parse(n.responseText)) : (t.player.notice('LRC file request fails: status ' + n.status), (t.parsed[e] = [['00:00', 'Not available']])),
                      ...
                      this.on('ended', function () {
                        'none' === e.options.loop
                          ? 'list' === e.options.order
                            ...
                            : 'random' === e.options.order && (e.randomOrder.indexOf(e.list.index) < e.randomOrder.length - 1 ? (e.list.switch(e.nextIndex()), e.play()) : (e.list.switch(e.nextIndex()), e.pause()))
                          : 'one' === e.options.loop
